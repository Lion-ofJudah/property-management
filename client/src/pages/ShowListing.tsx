...
export default function ShowListing() {
  ...
  return (
    <div className="flex flex-col pt-6 px-8 min-h-[calc(100vh-80px)] w-full lg:w-3/5 mx-auto">
      {loading ? (
        ...
        <div className="w-full">
          ...
          <div className="sm:grid sm:grid-cols-3 gap-4">
            ...
            <div className="flex items-center justify-center sm:justify-end mt-2 sm:mt-4 text-center">
              <div className="flex items-center flex-wrap  justify-center font-medium cursor-pointer text-lg sm:text-2xl border py-5 sm:py-16 px-5 rounded-3xl shadow-sm hover:shadow-md">
                <p>
                  ETB{" "}
                ...
                {listing.offer && (
                  <p className="bg-secondary px-6 rounded-2xl py-3">
                    ETB{" "}
                    <span className="text-fontColor ml-2">
